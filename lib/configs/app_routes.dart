...
import 'package:latihan5/modules/home_screen/home_screen.dart';
import 'package:latihan5/modules/news_detail_screen/news_detail_screen.dart';
import 'package:latihan5/modules/splash_screen/splash_screen.dart';
...
class AppRoutes {
  ...
  {
    return  const MaterialPage(
      child: HotLineNews(newsDetailHot: newsDetailHot),
      );
    }
